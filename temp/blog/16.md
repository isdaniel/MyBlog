...
- [ControllerActionInvoker中 重要的InvokeAction方法](#controlleractioninvoker%e4%b8%ad-%e9%87%8d%e8%a6%81%e7%9a%84invokeaction%e6%96%b9%e6%b3%95)
...
## ControllerActionInvoker中 重要的InvokeAction方法
...
2. 利用`ExtractParameterFromDictionary`方法動態取得傳入`IDictionary<string, object> parameters`參數
